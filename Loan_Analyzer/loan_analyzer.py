...
with open('inexpensive_loans.csv', 'w') as csvfile:
    loanparams = ['loan_price', 'remaining_months',
    ...
    for loan in inexpensive_loans:
        csvwriter.writerow({'loan_price': loan['loan_price'], 'remaining_months': loan['remaining_months'],
                           'repayment_interval': loan['repayment_interval'], 'future_value': loan['future_value']})
